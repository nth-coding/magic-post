...
async function loadData() {
  try {
    ...
    let pendingPackages = await PackageService.listPendingForStaffTran()
    ...
    let sentPackages = await PackageService.listSentForStaffTran()
    ...
    let currentPackages = await PackageService.listCurrForStaffTran()
    ...
    let receivedPackages = await PackageService.listRecForStaffTran()
...
function handleConfirm(id: number) {
  // await PackageService.confirmPackage(id)
}
