<template>
        ...
        <!-- breadcrumb -->
            ...
            <div class="lg:flex justify-between items-center mb-6">
              <div class="text-2xl font-semibold mb-2 lg:mb-0">
                <p v-if="currentTime >= 4 && currentTime < 12">Good morning, {{ firstName + ' ' + lastName }}</p>
                <p v-if="currentTime >= 12 && currentTime < 19">Good afternoon, {{ firstName + ' ' + lastName }}</p>
                <p v-else>Good evening, {{ firstName + ' ' + lastName }}</p>            
              </div>
            </div>
            ...
            <div class="flex flex-wrap -mx-3">
              ...
              <div class="w-full xl:w-1/3 px-3">
                <p class="text-xl font-semibold mb-4">Các loại hàng được vận chuyển</p>
              ...
              <div class="w-full xl:w-1/3 px-3">
                <p class="text-xl font-semibold mb-4">Hiệu suất chuyển phát</p>
                <div class="w-full bg-white border rounded-lg p-4 mb-8 xl:mb-0">
                  <canvas id="efficiency" width="300" height="300"></canvas>
                </div>
  ...
  export default {
    ...
    data() {
        return {
            typeData: {
              type: 'bar',
              data: {
                labels: ["Hàng dễ vỡ", "Tài liệu", "Hàng tiêu dùng"],
                datasets: [{
            ...
            efficiency: {
              type: 'doughnut',
              data:{
                labels: ["Đã giao", "Đang thực hiện","Thất bại"],
                datasets: [{
                  label: 'My First Dataset',
                  data: [300, 50, 100],
                  backgroundColor: [
                    'rgba(173,198,229,255)',
                    'rgba(74,127,176,255)',
                    'rgba(91,155,213,255)'
                  ],
    ...
    mounted () {
        new Chart(document.getElementById('type-chart'), this.typeData)
        new Chart(document.getElementById('count-chart'), this.countData)
        new Chart(document.getElementById('efficiency'), this.efficiency)
    },
    computed: {
      currentTime() {
